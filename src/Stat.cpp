...
long long Stat::getId() const {
    return this->id;
}

std::string Stat::getNumber1() const {
    return this->number_1;
}

std::string Stat::getNumber2() const   {
    return this->number_2;
}

std::string Stat::getResult() const   {
    return this->result;
}

std::time_t Stat::getTimeStarted() const   {
    return this->timeStarted;
}

std::time_t Stat::getTimeFinished() const   {
    return this->timeFinished;
}

double Stat::getTimeElapsed() const   {
